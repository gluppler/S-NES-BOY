...
2. If not, create a new issue with:
   ...
   - Relevant section/page reference
...
- Use hardware-accurate terminology
- Include code examples where appropriate
- Add cross-references to related sections
- Keep cheatsheets dense and table-focused
- Maintain the hardware-first philosophy
...
- Hardware-accurate explanations
- Code examples (when applicable)
- Cross-references to related sections
- Tables/diagrams for complex information
