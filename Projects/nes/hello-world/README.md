...
- ❌ **SNES: Does not apply (see `../../snes/` for SNES projects)

A complete NES program that displays text using a full alphabet/lexicon (A-Z, 0-9, punctuation). The code follows S-NES-BOY documentation best practices and includes a text rendering system.

## Overview

This program demonstrates complete text rendering on the NES with a full character set. It serves as a foundational example for understanding NES programming within the S-NES-BOY codebase.
