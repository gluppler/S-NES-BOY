...
; ============================================================================
; Displays "WELCOME TO S-NES" centered on screen
...
clear_attribute_table:
    ...
    ; Write centered "WELCOME TO S-NES" text
    ; Text is 17 characters, screen is 32 tiles wide
    ; Center: (32 - 17) / 2 = 7.5, round down to 7 columns from left
