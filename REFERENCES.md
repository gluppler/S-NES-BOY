# S-NES-BOY - Complete Reference List

Official and authoritative resources for NES, SNES, and Game Boy programming and development.
...
## Famicom Disk System Documentation
...
- **higan (Multi-System Emulator - SNES Recommended)
  - URL: https://higan.readthedocs.io/en/stable/
  - Official Documentation: https://higan.readthedocs.io/en/stable/
  - Repository: https://github.com/higan-emu/higan
  - Description: Highly accurate multi-system emulator. Recommended for SNES development with cycle-accurate emulation and comprehensive debugging tools. Supports NES, SNES, Game Boy, and other systems.
...
This reference list is maintained as part of the S-NES-BOY project. All external links are provided for educational purposes. Please verify link validity and respect the terms of use for each resource.

---

**Last Updated: 2025
**Maintained By: S-NES-BOY Contributors
