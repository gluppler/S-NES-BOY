...
- ❌ **SNES**: Does not apply (SNES PPU has different architecture, rendering rules, and VRAM access patterns)

**Note**: SNES PPU uses different rendering modes, multiple layers, and different VRAM access rules. This document covers NES/Famicom PPU only.
