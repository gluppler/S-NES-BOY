...
- ✅ **Famicom**: Fully compatible (same Ricoh 2A03 APU, plus expansion audio support)
- ❌ **SNES**: Does not apply (SNES uses SPC700 audio processor with completely different architecture)

**Famicom-Specific Notes:**
- Famicom supports **expansion audio** via cartridge (additional sound channels)
...
**Note**: SNES uses a separate SPC700 audio processor with 8 channels, sample playback, and echo/reverb. This document covers NES/Famicom APU only.
