...
- ✅ **Famicom**: Fully compatible (same graphics system)
- ⚠️ **SNES**: Partially applicable (SNES has different graphics constraints - multiple layers, Mode 7, more colors)

**Note**: This document covers both NES/Famicom and SNES graphics constraints. SNES sections are clearly marked. NES/Famicom sections apply to both systems.

## Hardware Constraints

Graphics on retro consoles (NES, SNES, Famicom) are fundamentally tile-based. Understanding these constraints is essential for creating effective pixel art.

### NES/Famicom Constraints
...
Based on techniques from Japanese game development (Famicom/NES era):
...
* **SNES**: Can use more colors for smoother gradients
...
**Note**: This guide follows the hardware-first, assembly-aware philosophy of this project. All techniques are verified against actual hardware behavior and constraints.
