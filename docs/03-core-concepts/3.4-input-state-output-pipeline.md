...
- ✅ **NES**: Primary focus
- ✅ **Famicom**: Fully compatible (same input/output architecture)
- ⚠️ **SNES**: Conceptually similar but different implementation (different controller protocol, different output systems)

**Note**: SNES follows similar pipeline patterns but uses different controller communication and has different audio/video output systems. This document covers NES/Famicom pipeline.
