...
- ✅ **NES**: Primary focus
- ✅ **Famicom**: Fully compatible (same PPU and tile system)
- ⚠️ **SNES**: Concepts apply but SNES has different tile organization and multiple background layers

**Note**: SNES map systems use similar principles (metatiles, compression) but SNES has multiple background layers and different tile organization. This document covers NES/Famicom map systems.
...
* **Attribute decoding**: Fast (lookup table), can be done on-demand
