...
- ✅ **NES**: Primary focus
- ✅ **Famicom**: Fully compatible (same timing)
- ❌ **SNES**: Does not apply (SNES has different frame timing and scanline counts)

**Note**: SNES has different frame timing (262 scanlines NTSC, different VBlank timing). This cheatsheet covers NES/Famicom timing only.
