...
- ✅ **Famicom**: Fully compatible (same APU, plus expansion audio support)
- ❌ **SNES**: Does not apply (SNES uses SPC700 audio processor with different architecture)
...
**Note**: SNES uses SPC700 audio processor with 8 channels, sample playback, and echo/reverb. This cheatsheet covers NES/Famicom APU only.
