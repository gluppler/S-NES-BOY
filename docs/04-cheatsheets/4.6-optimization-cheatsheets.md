...
- ⚠️ **SNES**: Concepts apply but SNES has different constraints (more RAM, faster CPU, different architecture)

**Note**: Optimization principles apply to SNES, but SNES has different hardware characteristics that change optimization priorities.
