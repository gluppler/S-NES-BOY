...
- ✅ **NES**: Primary focus
- ✅ **Famicom**: Fully compatible (same PPU scrolling system)
- ⚠️ **SNES**: Concepts apply but SNES has multiple background layers and different scroll registers

**Note**: SNES scrolling uses similar principles but SNES has multiple background layers with independent scrolling. This document covers NES/Famicom scrolling patterns.
