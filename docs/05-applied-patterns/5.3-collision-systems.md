...
- ✅ **NES**: Primary focus
- ✅ **Famicom**: Fully compatible (same tile system)
- ⚠️ **SNES**: Concepts apply but SNES has multiple background layers affecting collision detection

**Note**: SNES collision systems follow similar principles but must account for multiple background layers. This document covers NES/Famicom collision patterns.
