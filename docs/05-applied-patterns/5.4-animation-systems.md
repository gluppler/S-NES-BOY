...
- ✅ **NES**: Primary focus
- ✅ **Famicom**: Fully compatible (same sprite and tile system)
- ⚠️ **SNES**: Concepts apply but SNES has different sprite system and animation capabilities

**Note**: SNES animation follows similar patterns but SNES has more sprites and different OAM organization. This document covers NES/Famicom animation patterns.
