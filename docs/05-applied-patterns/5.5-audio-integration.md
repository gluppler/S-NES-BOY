...
**Note**: SNES uses SPC700 audio processor with different tools (SPC700 assembler, different music formats). This document covers NES/Famicom audio integration only.
