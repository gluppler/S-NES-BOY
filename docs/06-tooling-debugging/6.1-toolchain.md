...
- ✅ **Famicom**: Fully compatible (same toolchain)
- ⚠️ **SNES**: Partially applicable (ca65 supports 65816, but SNES development may require additional tools)

**Note**: ca65 supports 65816 CPU (SNES), but SNES development may require additional tools for SPC700 audio and SNES-specific features. This document focuses on NES/Famicom toolchain.
