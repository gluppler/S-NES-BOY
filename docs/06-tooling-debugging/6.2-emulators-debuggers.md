...
- ✅ **Famicom**: Fully compatible (same emulators)
- ⚠️ **SNES**: Partially applicable (SNES requires different emulators like bsnes, Snes9x)

**Note**: SNES development requires SNES-specific emulators (bsnes, Snes9x) with different debugging features. This document covers NES/Famicom emulators only.
