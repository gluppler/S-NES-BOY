...
- ✅ **NES**: Primary focus
- ✅ **Famicom**: Fully compatible (same test ROMs)
- ⚠️ **SNES**: Partially applicable (SNES has different test ROMs for 65816 CPU and SNES-specific hardware)

**Note**: SNES requires different test ROMs for 65816 CPU and SNES-specific hardware (PPU, SPC700). This document covers NES/Famicom test ROMs only.
