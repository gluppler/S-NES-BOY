...
The SNES CPU has a 24-bit address bus, providing 16 MB ($000000–$FFFFFF) of addressable space. This space is divided into:

* **WRAM: 128 KB of work RAM (banks $7E-$7F)
* **ROM: Cartridge ROM (banks $00-$7F for LoROM, $C0-$FF for HiROM)
* **I/O Registers: PPU, APU, DMA, and other hardware registers ($2100–$21FF, $4200–$43FF)
* **Cartridge Space: ROM, SRAM, enhancement chips

The PPU has its own address space separate from the CPU bus for VRAM, CGRAM, and OAM.
