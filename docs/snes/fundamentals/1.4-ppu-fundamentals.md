...
The SNES PPU (Picture Processing Unit) is a separate chip from the CPU, operating at approximately 21.477 MHz (NTSC) or 21.281 MHz (PAL). The PPU has:
...
* Mode 7 special effects (rotation/scaling)
