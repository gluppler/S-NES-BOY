...
**Note: This document covers both NES/ and SNES graphics constraints. SNES sections are clearly marked. NES/ sections apply to both systems.

## Hardware Constraints

Graphics on retro consoles (NES, SNES, ) are fundamentally tile-based. Understanding these constraints is essential for creating effective pixel art.
