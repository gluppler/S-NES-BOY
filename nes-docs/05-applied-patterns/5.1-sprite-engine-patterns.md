...
- ✅ **: Fully compatible (same sprite system)
- ⚠️ **SNES: Concepts apply but SNES has different sprite system (128 sprites, 32 per scanline, different OAM structure)

**Note: SNES sprite patterns follow similar principles but SNES has more sprites and different OAM organization. This document covers NES/ sprite patterns.
...
**Pattern: Allocate sprite slots on-dem and from a free list. Sprites are allocated when entities spawn and freed when entities despawn.
