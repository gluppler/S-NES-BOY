...
**Note: SNES scrolling uses similar principles but SNES has multiple background layers with independent scrolling. This document covers NES/ scrolling patterns.
