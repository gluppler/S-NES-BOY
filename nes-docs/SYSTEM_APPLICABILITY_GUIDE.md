...
This guide explains how S-NES-BOY documentation applies to different systems (NES, SNES, Game Boy).

## Quick Reference

### Fully Compatible (NES = )
- All fundamentals (1.1-1.5) - NES and are hardware-identical
...
###  Disk System (FDS)
- -only feature (not available on NES)
...
- ✅ **: Complete coverage (same as NES with additional features noted)
