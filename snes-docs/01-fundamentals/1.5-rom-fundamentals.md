# 1.5 SNES ROM Fundamentals

## System Applicability

**This document applies to:**
- ✅ **SNES: Primary focus
- ❌ **NES: Does not apply (different ROM format and header structure)
...
SNES ROM header (typically at $FFB0-$FFDF in HiROM or $7FB0-$7FDF in LoROM):
* Game title
* ROM/RAM size
* Region code
* Checksum
...
.segment "HEADER"
    ...
    .byte "SNES ROM TITLE    "  ; 21 bytes title
    .byte $20                    ; ROM type
    .byte $00                    ; ROM size
    .byte $00                    ; SRAM size
    .byte $00                    ; Region (NTSC)
...
```asm
; Complete SNES ROM structure with proper header
.segment "HEADER"
    ; SNES ROM header (HiROM format, at $FFB0)
    .org $FFB0
    .byte "MY SNES GAME     "  ; 21-byte title
