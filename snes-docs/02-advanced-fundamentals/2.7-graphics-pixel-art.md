# 2.7 SNES Graphics & Pixel Art

## System Applicability

**This document applies to:**
- ✅ **SNES**: Primary focus
- ❌ **NES**: Does not apply (see NES-specific graphics documentation)

## Overview of PPU Concepts

### Super PPU

The **Super PPU** (Picture Processing Unit) is the video controller chip that handles the SNES' tile graphics, scroll planes, and sprites. Similar in function to the PPU in NES, but with enhanced capabilities.
...
Similar to OAM in NES, but with enhanced capabilities.
...
**"Super Nintendo (SNES)"**, 60Hz machines, primarily found in:
* North America
* Certain countries in South America
* The Philippines, Myanmar, Taiwan, South Korea, and Japan

**Screen Resolution**: 256×224 px (just like NTSC NES)
...
The SNES can handle up to **4 graphics planes**, named **BG1-BG4**. These graphic planes can be scrolled as necessary.
...
### 8. Color Theory for SNES Graphics
...
* **Saturation**: SNES colors are naturally vibrant; use this to advantage
...
Finding good software for creating retro graphics, quantizing pixel art into tiles, and reducing the color count to handle the SNES various video modes can be difficult. Below is a list of recommended art software and specialized emulators that allow the user to look at VRAM contents and planes.
...
* **Features**:
  - Very accurate, cycle-accurate emulation of SNES hardware
  - Should be used for emulating/debugging SNES hardware issues
...
- [1.1 SNES System Overview](../01-fundamentals/1.1-snes-system-overview.md) - Hardware overview
...
- [Mega Cat Studios: Super Nintendo Graphic Guide](https://megacatstudios.com/blogs/retro-development/super-nintendo-graphic-guide) - Comprehensive SNES graphics guide
- [SNESDev Website](https://snes.nesdev.org/wiki/) - SNES development resources
- [SNES Sprites](https://snes.nesdev.org/wiki/Sprites) - Sprite documentation
- [SNES Palette Info](https://snes.nesdev.org/wiki/CGRAM) - Palette information
- [SNES BG Layer Info](https://snes.nesdev.org/wiki/Backgrounds) - Background layer documentation
- [PAL/NTSC Thread](https://snes.nesdev.org/wiki/PAL) - PAL vs NTSC differences

---

**Note**: This guide follows the hardware-first, assembly-aware philosophy of this project. All techniques are verified against actual hardware behavior and constraints. Information based on Mega Cat Studios Super PPU Graphics Guide v0.1 (10/09/17).
