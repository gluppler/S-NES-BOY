...
**Note: SNES map systems use similar principles (metatiles, compression) but SNES has multiple background layers and different tile organization. This document covers NES/ map systems.
