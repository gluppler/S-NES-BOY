...
1. **Assembly**: Source files in `src/` are assembled using `ca65`
...
- **Final ROM** (`.nes`) – The output artifact ready for emulation or hardware
...
- [NES Toolchain Documentation](../../../docs/nes/06-tooling-debugging/6.1-toolchain.md) – Toolchain setup and usage
